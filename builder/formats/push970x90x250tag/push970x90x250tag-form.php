...
<div class='col-lg-12 col-md-12'>
    <p class="h5 left" style='margin-top:14px'>#2 Content Push - 970x90 to 970x250 External Tag</p>
</div></div>
...
<br>
	...
	<table>
		...
		<input type="hidden" name="format" value='push970x90x250tag'>
<!--
...
-->
    ...
    <div class="text-center">
        <button onclick='w.builder.submit()' class="btn btn-primary">Generate Creative <i class="fa fa-paper-plane-o ml-1"></i></button>
