...
<div class='col-lg-12 col-md-12'>
    <p class="h5 left" style='margin-top:14px'>#1 Content Push - 970x90 to 970x250</p>
</div></div>
...
<br>
	...
	<table>
		...
		<input type="hidden" name="format" value='push970x90x250'>
<!--
...
-->		
		<tr><td>970x90 zip or image:</td>
			<td><input type="file" name='collapsed_zip'></td></tr>

		<tr><td>970x250 zip or image:</td>
