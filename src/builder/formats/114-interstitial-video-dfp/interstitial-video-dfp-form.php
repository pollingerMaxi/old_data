...
<div class='col-lg-12 col-md-12'>
    <p class="h5 left" style='margin-top:14px'>#114 - Video DFP Interstitial</p>
</div></div>
...
<br>
	...
	<table>
		<input type="hidden" name="format" value='interstitial-video-dfp'>
...
-->		
		<tr><td>DFP Ad unit Path</td>
			<td><input style='width:400px' name='adunit'><br>/21634433536/special/video<br>&nbsp;</td></tr>

		<tr><td>DFP key value "id"</td>
			<td><input style='width:400px' name='videoid'><br>1234<br>&nbsp;</td></tr>
<!--
