...
<div class='col-lg-12 col-md-12'>
    <p class="h5 left" style='margin-top:14px'>#108 - Fixed Footer</p>
</div></div>
    <p class="h5 left" style='margin-top:14px'>No special implementation is needed. Just use <a href='html5'>HTML5</a></p>
<!--
<div class="row">
	...
	<table> 
		...
		<tr><td>Size:</td>
			<td><select type="text" id='size' name="size" class="form-control">
				...
				<option value='900x60'>900x60</option>
